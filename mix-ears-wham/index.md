...
Signals from EARS were filtered with a biquad highpass filter (cutoff 70 Hz) to remove low-frequency noise.

Here, we report signals with __2__ channels for web compatibilty – in practice, we use signals with __4__ channels.
